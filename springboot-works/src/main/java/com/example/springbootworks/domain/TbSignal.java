 ...
 * @TableName tb_signal
 */
@TableName(value ="tb_signal")
@Data
public class TbSignal implements Serializable {
    /**
     * 自增主键
     */
    ...
    public TbSignal(long l, int i, BigDecimal valueOf, BigDecimal valueOf1, BigDecimal o, BigDecimal o1, LocalDateTime now, int i1) {
        this.id = l;
        this.carId = i;
        this.mx = valueOf;
        this.mi = valueOf1;
